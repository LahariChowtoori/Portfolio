...
const ExperienceCard = ({title,subTitle,result,description}) => {
  return (
    ...
    <div className="w-full bg-[gray] bg-opacity-30 
    hover:bg-opacity-30 duration-300 
    rounded-lg p-4 lgl:px-10 flex flex-col 
    justify-center gap-6 lgl:gap-10">
        <div className="flex flex-col lgl:flex-row justify-between gap-4 lgl:gap-0 lgl:items-center">
            <div>
                ...
                <div>
                    <p className="w-fit px-4 py-2 text-designColor bg-[gray]  bg-opacity-25 rounded-lg flex justify-center items-center shadow-shadowOne text-sm font-medium">
              {result}
                    </p>
                </div>
            </div>
